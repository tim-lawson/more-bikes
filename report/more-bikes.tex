...
\begin{table}
  ...
  \begin{subfigure}{\textwidth}
    ...
    \begin{tabular}{ll}
      ...
      \\
      \midrule
      \texttt{max\_depth}         & \None, 1, 2, 5, 10, 20, 50
      \\
      \texttt{max\_leaf\_nodes}   & \None, 7, 15, 31, 63
      \\
      \texttt{min\_samples\_leaf} & 1, 2, 5, 10, 20, 50, 100
      \\
      \bottomrule
    \end{tabular}
...
\begin{table}[h]
  ...
  \begin{subfigure}{\textwidth}
    ...
    \begin{tabular}{llrr}
      ...
      \\
      Decision tree & Gradient-boosted decision tree & 13.5          & \num{2.72e-7}
      \\
      \bottomrule
    \end{tabular}
    \caption{ Single model for all stations.
