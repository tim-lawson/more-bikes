...
\begin{abstract}
  This report describes my approach to the `More Bikes' Kaggle competition, for which the
  task is to predict the number of available bikes at a set of rental stations in
  Valencia, Spain.
