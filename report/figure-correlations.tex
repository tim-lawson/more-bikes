\begin{figure}
  ...
  \caption{The Pearson correlation coefficients between pairs of quantitative features.
    The ordering of the features follows \cref{tab:features}.
    Features that have zero variance for the first case of sub-task 1 are excluded (\cref{sec:feature-selection}).
    The \texttt{timestamp} feature is also excluded because it is naturally correlated with the other temporal features.
  }
