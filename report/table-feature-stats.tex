\begin{table}
  ...
  \caption{The numbers of missing values (n/a) and distributional characteristics of the
    non-temporal quantitative features and the target variable (\texttt{bikes}).
    Features that have zero variance for the first case of sub-task 1 are excluded
